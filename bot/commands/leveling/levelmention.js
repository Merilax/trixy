...
module.exports.run = async (
    ...
    if (message.author.id !== message.guild.ownerId) return message.channel.send({ content: `${TxTE.emoji.block} Only the server owner may change this! Try \`overridemention\` to set your personal choice over this.` });
