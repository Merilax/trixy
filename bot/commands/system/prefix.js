...
module.exports.run = async (
    ...
    if (newPrefix.length > 11) return message.channel.send("<:quote:614100269386432526> Prefix can be at most 10 characters long.");
    if (newPrefix.match(/^[\w\d\s\W]{1,10}$/i) === false) return message.channel.send("<:quote:614100269386432526> Prefix can only contain letters, numbers, special characters like ! or . and whitespace.");
    ...
    if (created) {
        ...
        if (newPrefix === "reset") {
            ...
            return message.channel.send(`<:approve:614100268891504661> Custom prefix deleted.`);
        }
